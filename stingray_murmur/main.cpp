...
#define stingray_murmur_api __declspec(dllexport)

extern "C" {
  stingray_murmur_api uint64_t stingray_murmur_64(const char* str) {
    return murmur_hash_64(str, strlen(str), 0);
  }
  stingray_murmur_api uint32_t stingray_murmur_32(const char* str) {
